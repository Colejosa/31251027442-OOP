...
class Program
{
    static void Main(string[] args)
    {
        ...
        account.Withdraw(100m, "0000"); // Attempt 1
        account.Withdraw(100m, "1111"); // Attempt 2
        account.Withdraw(100m, "2222"); // Attempt 3 -> Lock

        // Further attempts should fail because account is locked
